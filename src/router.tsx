    ...
    // Main routes
    {
      ...
      children: [
        ...
        },
        {
          ...
          lazy: async () => ({
            Component: (
              await import("./pages/questions_factory/QuestionFactory")
            ).default,
          }),
        },
        {
          path: "topics",
          lazy: async () => ({
            Component: (await import("./pages/topics/Topics")).default,
          }),
        },
        {
          path: "sub-topics",
          lazy: async () => ({
            Component: (await import("./pages/topics/SubTopics")).default,
          }),
        },
